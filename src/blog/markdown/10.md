...
>例题1：[洛谷P1177【模板】快速排序](https://www.luogu.org/problemnew/show/P1177)
...
>例题2：[P3378 【模板】堆](https://www.luogu.org/problemnew/show/P3378#sub)
...
>例题3：[洛谷P3369 【模板】普通平衡树](https://www.luogu.org/problemnew/show/P3369 )
...
>例题：[洛谷SP1805 HISTOGRA - Largest Rectangle in a Histogram](https://www.luogu.org/problemnew/show/SP1805)
...
>[洛谷P3371 【模板】单源最短路径（弱化版）](https://www.luogu.org/problemnew/show/P3371)
...
>例题1：[洛谷 P1090 合并果子](https://www.luogu.org/problemnew/show/P1090#sub)
...
>例题2：[洛谷P4779 【模板】单源最短路径（标准版）](https://www.luogu.org/problemnew/show/P4779)
...
这就是堆优化dijkstra，O((n+m)logn)比某个~~死了的~~算法好多了
...
常用操作就是这些了，find在一定程度上可以替代KMP，+和substr可以构造字符串~~只要不是模板题或数据卡你~~，就算时间复杂度是错的，也能在你不会写时骗到更多的分，且调试难度极低，纯模拟至少能拿到分，只要你坚信，n^2过百万，暴力碾标算，根据常数的优秀以及NOIP的水数据就有可能得到AC的好成绩
...
>例题1：[洛谷 UVA10815 Andy's First Dictionary](https://www.luogu.org/problemnew/show/UVA10815)
...
>例题2：[洛谷 UVA136 Ugly Numbers](https://www.luogu.org/problemnew/show/UVA136)
...
map映射，它的内部实现也是一棵红黑树~~呵呵~~,同样，也因为常数较大使得效率较低
...
>例题1:[洛谷 P3370 【模板】字符串哈希](https://www.luogu.org/problemnew/show/P3370 )
...
>例题2：[洛谷 UVA156 Ananagrams](https://www.luogu.org/problemnew/show/UVA156 "洛谷 UVA156 Ananagrams")
