        ...
        <v-row>
          ...
          <v-col cols="12">
            <v-card class="mt-4 pa-md-4">
              ...
              <v-card-text>
                <v-textarea outlined label="原始内容" v-model="filter.text"></v-textarea>
...
import { create, rationalizeDependencies, derivativeDependencies, evaluateDependencies, parseDependencies } from "mathjs"
import katex from 'katex'
import "katex/dist/katex.min.css"

const { rationalize, derivative, evaluate, parse } = create({
